 ...
 *
 */
public class DsSQLServerTemplates extends DsSQLTemplates {
    ...
    public static final DsSQLServerTemplates DEFAULT = new DsSQLServerTemplates();
    ...
    public DsSQLServerTemplates() {
        this('\\',false);
    }

    public DsSQLServerTemplates(boolean quote) {
        this('\\',quote);
    }

    public DsSQLServerTemplates(char escape, boolean quote) {
        this(Keywords.DEFAULT, escape, quote);
    }

    protected DsSQLServerTemplates(Set<String> keywords, char escape, boolean quote) {

...
public class DsPostgreSQLTemplates extends DsSQLTemplates implements Serializable {
    private static final long serialVersionUID = 6821107963963125848L;

    public DsPostgreSQLTemplates() {
        this('\\', true);
    }

    public DsPostgreSQLTemplates(boolean quote) {
        this('\\', quote);
    }

    @SuppressWarnings("FieldNameHidesFieldInSuperclass") //Intentional
    public static final DsPostgreSQLTemplates DEFAULT = new DsPostgreSQLTemplates();
    ...
    public DsPostgreSQLTemplates(char escape, boolean quote) {

 ...
 *
 */
public class DsMySQLTemplates extends DsSQLTemplates implements Serializable {
    ...
    public static final DsMySQLTemplates DEFAULT = new DsMySQLTemplates();
    private static final long serialVersionUID = -7324529090603821279L;
    ...
    public DsMySQLTemplates() {
        this('\\', false);
    }

    public DsMySQLTemplates(boolean quote) {
        this('\\', quote);
    }

    public DsMySQLTemplates(char escape, boolean quote) {

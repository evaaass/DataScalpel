...
//
//    public static DatasourceItemMetadata getJdbcItemMetadata(Connection connection, JdbcConfig jdbcConfig, String tableName) {
//        DatasourceItemMetadata itemMetadata = new DatasourceItemMetadata();
//        DmpJdbcDialect jdbcDialect = DmpJdbcDialects.get(jdbcConfig.getJDBCDBType());
...
//            itemColumnMetadata.setType(SchemaUtil.getColumnType(jdbcConfig.getJDBCDBType(), field.dataType(), field.metadata(), column.getTypeName().replaceAll(" UNSIGNED", "")));
...
//                if (itemColumnMetadata.getType() == FieldType.STRING && precision >= 2000) {
//                    precision = 0;
//                } else if (itemColumnMetadata.getType() == FieldType.FIXEDSTRING && precision >= 2000) {
//                    precision = 2000;
//                } else if (itemColumnMetadata.getType() == FieldType.DECIMAL && precision == 0 && column.getDigit() == 0) {
//                    precision = 38;
//                }
...
//        }
//        itemMetadata.setName(table.getTableName());
//        //TODO 这个工具类获取cnName
//        itemMetadata.setCnName(JdbcCommentUtil.getAliasFromComment(table.getComment()));

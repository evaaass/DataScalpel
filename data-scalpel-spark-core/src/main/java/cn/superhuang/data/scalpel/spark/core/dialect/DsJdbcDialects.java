...
public class DsJdbcDialects {

    private static List<DsJdbcDialect> dialects = new ArrayList<>();
...
//        JdbcDialects.registerDialect(new OceanBaseMySQLDialect());
    ...
    public static DsJdbcDialect get(DbType type) {
        for (DsJdbcDialect dialect : dialects) {

...
import cn.superhuang.data.scalpel.actuator.canvas.node.processor.configuration.action.SubStringAction;
 ...
 */
@Data
public class SubStringConfiguration extends NodeConfiguration {
    @Schema(description = "配置项")
    private List<SubStringAction> actions;
}
